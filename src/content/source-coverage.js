...
export const sourceCoverageMatrix = Object.freeze({
  ...
  planning: chapter(
    ...
    [
      ...
      required('value-iteration-example', 'worked-example', 'Interactive four-state Value Iteration executor with three visible sweep-and-commit cycles', ['vi-complete-loop'], ['value-iteration']),
      ...
      required('policy-iteration-example', 'worked-example', 'Interactive two-round policy evaluation and greedy improvement with visible intermediate values', ['pi-four-whys'], ['policy-iteration']),
      required('policy-iteration-grid-sequence', 'worked-example', 'Intermediate policy and value maps on the shared 5×5 grid', ['chapter-experiment'], ['policy-iteration']),
      required('truncated-pi', 'variant', 'Truncated Policy Iteration', ['truncated-evaluation', 'tpi-continuum'], ['truncated-pi']),
      required('truncated-value-improvement', 'theorem', 'Warm-start and greedy-policy conditions for truncated evaluation', ['truncated-evaluation', 'tpi-continuum'], ['truncated-pi']),
      required('evaluation-depth', 'comparison', 'Interactive VI, TPI, and PI evaluation-depth schedules on one improve cycle', ['tpi-continuum', 'fair-budget'], ['value-iteration', 'policy-iteration', 'truncated-pi']),
