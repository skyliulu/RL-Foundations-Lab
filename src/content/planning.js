...
const planningDeepeningZh = [
  ...
  {
    id: 'pi-four-whys', kicker: '算法二 · Policy Iteration', title: 'Policy Iteration 的完整循环由四项机制构成',
...
const planningDeepeningEn = [
  ...
  {
    id: 'pi-four-whys', kicker: 'Algorithm two · Policy Iteration', title: 'Four mechanisms determine the complete Policy Iteration loop',
...
export const planningChapter = assertFoundationChapterDefinition({
  ...
  zh: {
    ...
    title: '通向同一 Bellman 最优不动点的不同评估深度',
  ...
  en: {
    ...
    title: 'Different evaluation depths toward the same Bellman optimal fixed point',
