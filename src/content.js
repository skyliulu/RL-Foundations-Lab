...
export const copy = {
  zh: {
    ...
    chapters: [
      ...
      { id: 'control', number: '09', kicker: '无模型控制', title: 'Sarsa 与 Q-learning', subtitle: '比较实际下一动作与后继最大值' },
  ...
  en: {
    ...
    chapters: [
      ...
      { id: 'control', number: '09', kicker: 'Model-free control', title: 'Sarsa and Q-learning', subtitle: 'Compare the realized next action with the successor maximum' },
